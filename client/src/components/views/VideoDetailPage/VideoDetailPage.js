                ...
                <Row gutter={[16, 16]}>
                    <Col lg = {18} xs = {24}>
                        ...
                        <div style = {{width : '100%', padding : '3rem 4rem'}}>
                            ...
                            <List.Item
                                actions = {[
                                    <LikeDislikes video postId = {props.match.params.videoId}/>,
                                    user.userData._id !== videoDetail.writer._id && <Subscribe userTo = {videoDetail.writer._id} userFrom = {user.userData._id}/>,
                                ]}
                            >
                                <List.Item.Meta
